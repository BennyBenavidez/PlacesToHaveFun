...
//equal to a certain combination in which one of the three intensities are picked and the money is
//above or below a certain value
function updateScreen() {
if (intensity == "Relaxing" && money < 50) {
  activityType = "park";
  setText("textOutput", "For $" + money + (" and you want a " + intensity + " intensity, I recommend going to a " + activityType ));
} else if ((intensity == "Relaxing" && money >= 50)) {
  activityType = "boat ride";
   setText("textOutput", "For $" + money + (" and you want a " + intensity + " intensity, I recommend going for a " + activityType ));
